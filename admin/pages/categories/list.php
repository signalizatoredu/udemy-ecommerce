...
<?php if (!empty($rows)){ ?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
        ...
        <tr>
            ...
            <td class="ta_r"><a href="/admin/?page=categories&amp;action=remove&amp;id=<?php echo $category['id']; ?>">Remove</a></td>
            <td class="ta_r"><a href="/admin/?page=categories&amp;action=edit&amp;id=<?php echo $category['id']; ?>">Edit</a></td>
        </tr>

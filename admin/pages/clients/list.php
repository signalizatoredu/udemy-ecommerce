...
<form action="" method="get">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        <tr>
            ...
            <td>
                <input type="text" name="srch" id="srch" value="<?php echo stripslashes($srch); ?>" class="fld" />
            </td>
            <td>
...
<?php if (!empty($rows)){ ?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
        ...
        <tr>
            ...
            <td class="ta_r"><a href="/admin/?page=clients&amp;action=edit&amp;id=<?php echo $user['id']; ?>">Edit</a></td>
        </tr>

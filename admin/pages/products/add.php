    ...
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        ...
        <tr>
            ...
            <td>
                ...
                <textarea name="description" id="description" cols="" rows="" class="tar_fixed"><?php echo $objForm->stickyText('description'); ?></textarea>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <label for="btn" class="sbm sbm_blue fl_l">
                    <input type="submit" it="btn" class="btn" value="Add" />
                </label>
            </td>
        </tr>

...
<form action="" method="post">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        ...
        <tr>
            ...
            <td>
                <input type="password" name="login_password" id="login_password" class="fld" value="<?php echo $objForm->stickyText('login_password'); ?>" />
            </td>
        </tr>
        <tr>
            <th>&#160;</th>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="first_name" id="first_name"
                       class="fld" value="<?php echo $objForm->stickyText('first_name'); ?>" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="last_name" id="last_name"
                       class="fld" value="<?php echo $objForm->stickyText('last_name'); ?>" />
            </td>
        </tr>   
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="address_1" id="address_1"
                       class="fld" value="<?php echo $objForm->stickyText('address_1'); ?>" />
            </td>
        </tr>    
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="address_2" id="address_1"
                       class="fld" value="<?php echo $objForm->stickyText('address_2'); ?>" />
            </td>
        </tr>     
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="town" id="town"
                       class="fld" value="<?php echo $objForm->stickyText('town'); ?>" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="county" id="county"
                       class="fld" value="<?php echo $objForm->stickyText('county'); ?>" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                ...
                <input type="text" name="post_code" id="post_code"
                       class="fld" value="<?php echo $objForm->stickyText('post_code'); ?>" />
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="email" id="email"
                       class="fld" value="<?php echo $objForm->stickyText('email'); ?>" />
            </td>
        </tr>       
        <tr>
            <th>

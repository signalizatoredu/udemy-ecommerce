...
if (!empty($id)){
    ...
    if (
        ...
        $ojbBusiness = new Business();
        $business = $ojbBusiness->getBusiness();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div style="width:50%;float:fight;text-align:right;"></div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
            ...
            <tr>
                ...
                <td class="ta_r">&pound;<?php echo number_format($objBasket->itemTotal($item['price'], $item['qty']), 2); ?></td>
            </tr>
